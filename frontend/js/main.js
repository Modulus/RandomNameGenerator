...
var author$project$Main$init = _Utils_Tuple2(
	A3(author$project$Main$Model, 'Generated name', 'Generated adjective', ''),
		...
		switch (msg.$) {
			...
			case 'Change':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{adjective: newModel.adjective, name: newModel.name}),
					elm$core$Platform$Cmd$none);
			case 'Generate':
				var newName = msg.a;
				var _new = msg.b;
...
var author$project$Main$Generate = F2(
	function (a, b) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(model.name + (' ' + model.adjective))
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								A2(author$project$Main$Generate, 'jada', 'neida')),
