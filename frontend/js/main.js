		...
		switch (msg.$) {
			...
			case 'LoadData':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{adjective: 'Fetching...', name: 'Fetching'}),
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Name Generator')
							]))
					])),
				A2(
				elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								_Utils_Tuple2('d-flex justify-content-center', true)
							]))
					]),
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Events$onClick(author$project$Main$LoadData),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Generating names out of 165 784 possible cominations')
							]))
					]))
			]));
};
